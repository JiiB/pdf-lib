...
var PDFPage = /** @class */ (function () {
     ...
     */
    PDFPage.prototype.drawLink = function (link, options) {
        var _a, _b;
        utils_1.assertIs(options.x, 'options.x', ['number']);
        utils_1.assertIs(options.y, 'options.y', ['number']);
        utils_1.assertIs(options.width, 'options.width', ['number']);
        utils_1.assertIs(options.height, 'options.height', ['number']);
        utils_1.assertOrUndefined(options.borderWidth, 'options.borderWidth', ['number']);
        utils_1.assertOrUndefined(options.color, 'options.color', [[Object, 'Color']]);
        var pdfRef = this.doc.context.register(this.doc.context.obj({
            Type: 'Annot',
            Subtype: 'Link',
            Rect: [
                // lower left x coord
            ...
            Border: [0, 0, (_a = options.borderWidth) !== null && _a !== void 0 ? _a : 0],
            /* Default to transparent */
            C: options.color ? colors_1.colorToComponents(options.color) : [],
            ...
            A: {
                Type: 'Action',
                S: 'URI',
                URI: core_1.PDFString.of(link),
            },
        }));
        // Annots Dictionary may or may not exist--create it if it doesn't.
        if (this.node.Annots()) {
            (_b = this.node.Annots()) === null || _b === void 0 ? void 0 : _b.push(pdfRef);
        }
        else {
            this.node.set(core_1.PDFName.Annots, this.doc.context.obj([pdfRef]));
        }
    };
    /**
